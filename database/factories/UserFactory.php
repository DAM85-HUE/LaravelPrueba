...
$factory->define(Estacionamiento::class, function (Faker $faker) {
    return array(
        ...
        'direccion' => 'Ibague callw sprinfield.',
        'telefono' => '(+57) 3115201459',
    );
});
...
$factory->define(Ocupacion::class, function (Faker $faker) {
    return array(
        ...
        'nodemcu_id' => 1,
        'created_at' => $faker->dateTimeBetween('01-01-2020','01-07-2020'),
        'updated_at' => $faker->dateTimeBetween('01-01-2020','01-07-2020'),
    );
});
